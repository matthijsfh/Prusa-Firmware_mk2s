...
const char MSG_FINISHING_MOVES[] PROGMEM_I1 = ISTR("Finishing moves"); ////MSG_FINISHING_MOVES c=20
...
const char MSG_FSENSOR_RUNOUT[] PROGMEM_I1 = ISTR("Fil. runout"); ////MSG_FSENSOR_RUNOUT c=13
